...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="h-screen w-screen">
        <img src="../assets/images/conexion.png" alt="" class="w-full h-full absolute object-cover" srcset="">
        <div class=" p-8 rounded-lg shadow-md w-full max-w-md absolute h-[60vh] top-40 left-[70vh] bg-[#DF8C07]"></div>
        <div class=" p-8 rounded-lg shadow-md w-full max-w-md absolute h-[60vh] top-36 left-[75vh]  bg-[#D70C0C]"></div>
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md relative mx-auto mt-36">
        ...
        <div>
            ...
            <button type="submit" name="add" class="w-full bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 transition duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                Se connecter
            </button>
        </form>
    </div>
